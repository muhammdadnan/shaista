...
const Happyrate = () => {
  ...
  return (
    <>
      <h1 className="text-5xl text-center md:m-[70px] font-bold leading-[57.6px] md:text-left">
        OUR HAPPY CUSTOMERS
      </h1>
      <div className="flex flex-cols-1 md:flex-row justify-evenly mb-28">
        <div className="w-[350px] lg:w-[400px] h-[250px] md:h-[240px] py-[28px] px-[10px] md:px-[32px] rounded-[20px] border-2">
          <div className="w-[336px] h-[161.58px] flex flex-col gap-4">
            ...
            <div className="flex gap-2 items-center">
              <p className="text-xl font-bold leading-[22px]">Sarah M.</p>
              <Image src={tick} alt="tick" className="w-[19.5px] h-[19.5px]" />
            </div>
            <p className="w-[336px] h-[88px] text-base font-normal leading-[22px] text-[#818181]">
        ...
        <div className="hidden md:flex w-[400px] h-[240px] py-[28px] px-[32px] rounded-[20px] border-2">
          <div className="w-[336px] h-[161.58px] flex flex-col gap-4">
            ...
            />
            <div className="flex gap-2 items-center">
              <p className="text-xl font-bold leading-[22px]">Alex K.</p>
              <Image src={tick} alt="tick" className="w-[19.5px] h-[19.5px]" />
            </div>
            <p className="w-[336px] h-[88px] text-base font-normal leading-[22px] text-[#818181]">
        ...
        <div className="hidden md:flex w-[400px] h-[240px] py-[28px] px-[32px] rounded-[20px] border-2">
          <div className="w-[336px] h-[161.58px] flex flex-col gap-4">
            ...
            />
            <div className="flex gap-2 items-center">
              <p className="text-xl font-bold leading-[22px]">James L.</p>
              <Image src={tick} alt="tick" className="w-[19.5px] h-[19.5px]" />
            </div>
            <p className="w-[336px] h-[88px] text-base font-normal leading-[22px] text-[#818181]">
              &quot;As someone who&apos;s always on the lookout for unique
              fashion pieces, I&apos;m thrilled to have stumbled upon Shop.co.
              The selection of clothes is not only diverse but also on-point

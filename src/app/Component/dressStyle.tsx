...
const DressStyle = () => {
  return (
    <>
    <div>
        <div className='bg-[#F0F0F0] h-[975px] w-[350px] sm:w-full  grid grid-cols-1  my-[50px] justify-center mx-[5%] rounded-[20px] md:w-auto md:h-[866px] md:rounded-[40px] md:mx-[100px]'>
